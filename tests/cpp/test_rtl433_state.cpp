...
void test_last_updated_resolution_backs_off_by_one_minute() {
  ...
  require(adjusted == 1699999940, "last_updated resolution should stay 60 seconds behind wall clock time");
}
...
int main() {
  ...
  test_last_updated_resolution_backs_off_by_one_minute();
